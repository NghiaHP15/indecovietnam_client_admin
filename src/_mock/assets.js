  ...
  children: [
    {
      ...
      route: 'product',
      order: 5,
      component: '/system-website/product/index.tsx',
      func: [
        {
          code: 'view',
          name: "View",
    ...
    },
    {
      ...
      order: 5,
      component: '/system-website/product-variant/index.tsx',
      func: [
        {
          code: 'view',
          name: "View",
    ...
    },
    {
      ...
      order: 5,
      component: '/system-website/product-category/index.tsx',
      func: [
        {
          code: 'view',
          name: "View",
    ...
    },
    {
      ...
      route: 'room-category',
      order: 5,
      component: '/system-website/room-category/index.tsx',
      func: [
        {
          code: 'view',
          name: "View",
